...
from firebase_db import get_patient_by_user, get_appointments_for_patient, get_waiting_for_patient
...
def patient_dashboard():
    ...
    if patient is None:
        flash("Patient profile not found. Please re-register.", "danger")
